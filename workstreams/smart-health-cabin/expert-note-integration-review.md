...
Smart Health Cabin bridge files.
...
```text
The Smart Health Cabin folder is a bridge for discovery and feasibility, not a
production implementation home.
```

This belongs in `README.md`, `reuse-from-ai-triage.md`, and the post-meeting
new-repo decision gate.
...
The sample API and ERD are good teaching artifacts, but the active bridge
folder should not create formal Smart Health Cabin API endpoints or database
schema yet. After `2026-06-23`, formal API/ERD design should trigger either:

- a dedicated design-spec phase; or
- a new repo such as `imedtac-smart-health-cabin-v0`.
